...
def plot_curves(results: dict, model_name: str) -> plt.Figure:
    ...
    # Loss
    axes[0].plot(epochs_range, results["train_losses"], label="Train", marker="o")
    axes[0].plot(epochs_range, results["val_losses"],   label="Val",   marker="o")
    ...
    # Accuracy
    axes[1].plot(epochs_range, results["train_accs"], label="Train", marker="o")
    axes[1].plot(epochs_range, results["val_accs"],   label="Val",   marker="o")
    ...
    # AUC
    axes[2].plot(epochs_range, results["train_aucs"], label="Train", marker="o")
    axes[2].plot(epochs_range, results["val_aucs"],   label="Val",   marker="o")
